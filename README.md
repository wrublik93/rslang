[Trello](https://trello.com/b/lRxRbr98)

Мы используем такие инструменты:
 - eslint - линтинг кода
 - prettier - форматтер кода
 - lint-staged - запуск скриптов только для коммитов со статусом staged
 - husky - использование хуков гита для коммитов
 - react - JavaScript-библиотека для создания пользовательских интерфейсов
 - react-router - маршрутизация приложения
 - react-hooks-global-state - глобальный стор
 - react-cookie - куки
 - bootstrap - библиотека стилей
 - react-bootsrap - библиотека готовых React компонентов
 - classnames - для использования множественных классов
 - node-sass - для использования Sass
 - svgo - для оптимизации svg
 - npm-run-all - для запуска множественных скриптов

![RACI Matrix](https://i.imgur.com/gHjqECx.png)
